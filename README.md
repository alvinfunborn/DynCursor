...
此工具能帮助快速判断所用的语言, 通过简单的几步配置, 即可在使用英文时看到鼠标白色指针, 使用中文时看到鼠标黑色指针; 也可以自制其他颜色和图标的指针;
...
- 仅支持语言切换(即无法监听`shift`切换输入法, 最好使用`win+space`或`alt+shift`来切换语言);

## 使用
1. 下载release, 解压到任意目录, 无需安装
